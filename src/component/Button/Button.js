...
function Button(props) {
  const {type, style, onClick, children, focus} = props;
  let output;
  let buttonClasses;
  ...
  switch(type) {
    ...
    case 1: {
      ...
      output=(<button type="button" autoFocus={focus} style={style} className={buttonClasses} onClick={onClick}>{children}</button>);
      break;
    }
    case 2: {
